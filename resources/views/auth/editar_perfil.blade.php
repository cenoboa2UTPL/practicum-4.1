            ...
            <form action="{{$this->route('usuario/update_profile')}}" method="post" enctype="multipart/form-data">
               ...
               <div class="card-footer text-end">
                  ...
                  <div class="alert alert-danger">
                    Complete sus datos por favor! <a href="{{$this->route("paciente/completar_datos")}}" class="btn btn-rounded btn-info btn-sm">Ir <i class='bx bx-right-arrow-alt'></i></a>
                  </div>
                  @endif
               </div>
           </form>
            ...
            <div class="card-body">
                <div class="card-text"><p class="h4">Cambiar contraseña </p></div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="pa" id="pa" class="form-control is-invalid">
                    </div>
                    <div class="form-group">
                        <label for="pass_nuevo"><b>Nuevo Password <span class="text-danger">(*)</span></b></label>
                        <input type="text" name="pass_nuevo" id="pass_nuevo" class="form-control is-invalid">
                    </div>

                    <div class="form-group">
                        <label for="cp"><b>Confirmar Password <span class="text-danger">(*)</span></b></label>
                        <input type="text" name="cp" id="cp" class="form-control is-invalid">
                    </div>
