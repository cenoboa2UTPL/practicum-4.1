            ...
            <div class="col-xl-4 col-lg-5 col-md-5 col-md-7">
                <div class="card border-primary">
                    <div class="card-header" style="background-color:#E6E6FA">
                        <div class="card-text">
                            <p class="h3 text-primary text-center letra">Create una cuenta</p>
                   ...
                   <div class="text-center mb-4 col-12">
                       <button class="btn_blue col-7" type="submit" id="register"><b>Registrarme <i class='bx bx-user-check'></i></b> </button>
                   </div>
                   </form>
                </div>
            </div>
