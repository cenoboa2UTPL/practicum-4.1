...
<div class="nav-align-top mb-4" id="cita_content">
    <ul class="nav nav-tabs nav-fill" role="tablist" id="ul_citas">
        ...
        <li class="nav-item">
            <button type="button" class="nav-link active" role="tab" data-bs-toggle="tab" data-bs-target="#cita_calendario"
               id="citasprogramados" aria-controls="navs-justified-profile" aria-selected="false" style="color:#0080ff">
                <i class="tf-icons bx bx-user"></i> <b>Citas programadas</b>
            </button>
        </li>
        @endif
        <li class="nav-item">
            <button type="button" class="nav-link" role="tab" data-bs-toggle="tab" data-bs-target="#cita_form"
                ...
                <i class="tf-icons bx bx-home"></i> <b>Registrar cita médica</b>
    ...
    <div class="tab-content">
        <div class="tab-pane fade @if($this->profile()->rol === 'Admisión') show active @endif"  id="cita_calendario" role="tabpanel">
        ...
        <div class="tab-pane fade  @if($this->profile()->rol === 'Paciente') show active @endif" id="cita_form" role="tabpanel">
            ...
            <form action="" method="post" id="form_cita_medica">
                <div class="row">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-7 col-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="medico" id="medico" readonly>
                        </div>
                    </div>
                ...
                <div class="d-flex flex-row mt-3 justify-content-end">
                     ...
                     <input type="text" class="form-control" id="importe" value="0.00">
                     </div>
                </div>
                <div class="row mt-5 justify-content-end">
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-5  m-xl-0 m-lg-0 m-md-0 m-1">
                        <button class="btn-save save_cita" style="width: 100%">Agendar cita <i class='bx bxs-save'></i></button>
                    </div>
...
<div class="modal fade" id="modal_new_paciente" data-bs-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header" style="background-color: #4169E1">
                <p class="h4 text-white" >Nuevo paciente <i class='bx bxs-user-plus'></i></p>
                <button class="btn btn-rounded btn-danger btn-sm" id="cerrar_modal_new_paciente">X</button>
            </div>
            <div class="modal-body">
               <div class="row">
                <div class="col-xl-8 col-lg-9 col-md-6 col-sm-6 col-12">
           ...
           <div class="mx-4" id="alerta_paciente" style="display: none">
            ...
            <div class="modal-footer">
                <button class="btn-save" id="save_paciente"><b>Guardar <i class='bx bxs-save' ></i></b></button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header bg bg-primary">
                <p class="h5 text-white mt-1"><span id="texto_cita_">Nueva cita</span>  <img src="{{$this->asset('img/icons/unicons/clinica.ico')}}" class="text-white" class="menu-icon" alt=""></p>
            ...
            <div class="modal-body">
                ...
                <form action="" method="post" id="form_cita_medica_modal">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                <label for="servicio_modal"><b> Atención de servicio (Opcional)</b></label>
                                <select name="servicio_modal" id="servicio_modal" class="form-select">
                    ...
                    <div class="row mt-5 justify-content-end">
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5  m-xl-0 m-lg-0 m-md-0 m-1">
                            <button class="btn btn-rounded btn-success save_modal_cita" style="width: 100%">Guardar<i class='bx bxs-save'></i></button>
                        </div>
                        
                        <div class="col-xl-2 col-lg-3 col-md-4 col-sm-5  m-xl-0 m-lg-0 m-md-0 m-1" style="display: none" id="anular_button">
                            <button class="btn btn-rounded btn-danger anular_cita" style="width: 100%">Anular<i class='bx bxs-save'></i></button>
                        </div>
                    </div>
                </form>  
            </div>
...
<div class="modal" id="modal_search_paciente" data-bs-backdrop="static">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header" style="background: #F0FFF0">
            <h5 class="text-dark mt-1">Consultar pacientes </h5>
            <img src="{{$this->asset('img/icons/unicons/paciente.ico')}}" class="menu-icon float-end text-white" alt="">
        </div>
        <div class="modal-body">
            <div class="table-responsive">
             
                <table class="table table-bordered table-striped nowrap" style="width: 100%" id="tabla_search_paciente">
                 <thead>
                    <tr>
                        <th>#</th>
                        <th># DOCUMENTO</th>
...
<script>
    ...
    *Verificamos si es paciente el documento es automático
     */
     ...
     if(PROFILE_ === 'Paciente')
     {
        ...
        ID_MEDICO_ESP_ = "{{$this->getSession('medico_esp_data')}}";
        ...
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    saveCitaMedica(Fecha.val(),Asunto.val(),Estado.val(),Horario_Id,PACIENTE_ID,$('#servicio').val(),Hora_cita,$('#importe').val(),ID_MEDICO_,Especialidad.val(),
                    CORREO,$('#paciente').val(),$('#medico').val(),$('#especialidad option:selected').text(),$('#servicio option:selected').text());
                }
            }
        }
    ...
    $('.save_modal_cita').click(function(evento){
      ...
      {
       if(Hora_text_cita.val().trim().length == 0 || $('#cita_horario_modal option').length<=1)
       {
        Swal.fire(
            {
                title:'Mensaje del sistema!',
        ...
        if(HORARIO_ID != null)
       {
        ...
        updateCitaMedica(CITA_ID,FechaCitaModal,AsuntoModal,HORARIO_ID,PACIENTE_ID,ServicioModal,Hora_text_cita,ImporteCitaModal,ID_MEDICO_,ID_ESP);
       }
       else
       {
    
        updateCitaMedica(CITA_ID,FechaCitaModal,AsuntoModal,HorarioCitaModal.val(),PACIENTE_ID,ServicioModal,Hora_text_cita,ImporteCitaModal,ID_MEDICO_,ID_ESP);
       }
       }
      }
    });
  ...
  function updateCitaMedica(id_cita_,fecha_cita_,obs_,horario_,paciente_,servicio_,horacita_,monto_,medico_,especialidad_)
  {
    $.ajax({
        ...
        success:function(response)
        {
            ...
            if(response.response === 'ok')
            {
              Swal.fire(
                {
                    title:'Mensaje del sistema!',
                    text:'La cita médica del paciente '+PACIENTE_TEXT,
                    icon:'success',
                    target:document.getElementById('modal_nueva_cita')
                }
              ).then(function(){
  ...
  function CitasPendientesNoAtendidos()
  {
    ...
    columns:[
        ...
        {"data":"estado",render:function(){return '<b class="text-danger">pendiente</b>';}},
  ...
  {
    let respuesta = show(RUTA+"procedimientos_por_medico/"+id+"?token_="+TOKEN);
    /// obtenemos el día por defecto
    let option = '<option disabled selected>--- Seleccione ---</option>';
    respuesta.forEach(proc => {
        option+=`
        <option value=`+proc.id_servicio+`>`+proc.name_servicio+`</option>
        `;
    });
  ...
  correo_,name_data,doctora_,esp_data,serv_data)
  {
    $.ajax({
