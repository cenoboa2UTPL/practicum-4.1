            ...
            <div class="tab-content">
              ...
              <div class="tab-pane" id="tab-5">
                <div class="row gy-4">
                  ...
                  <div class="col-lg-4 text-center order-1 order-lg-2">
                    <img src="public/assets/img/departments-5.jpg" alt="" class="img-fluid">
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row g-0">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="public/assets/img/gallery/gallery-1.jpg" class="galelry-lightbox">
                <img src="public/assets/img/gallery/gallery-1.jpg" alt="" class="img-fluid">
              </a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="public/assets/img/gallery/gallery-2.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="public/assets/img/gallery/gallery-3.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="public/assets/img/gallery/gallery-4.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="public/assets/img/gallery/gallery-5.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="public/assets/img/gallery/gallery-6.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="public/assets/img/gallery/gallery-7.jpg" class="galelry-lightbox">
          ...
          <div class="col-lg-3 col-md-4">
            <div class="gallery-item">
              <a href="public/assets/img/gallery/gallery-8.jpg" class="galelry-lightbox">
