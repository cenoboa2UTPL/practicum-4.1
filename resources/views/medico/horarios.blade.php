...
@section('contenido')
 ...
 <div class="card p-4">
    <div class="card-text float-end"><p class="h4">Mis Horarios de trabajo</p></div>
    <button class="btn_blue col-xl-4 col-lg-4 col-md-5 col-12" id="new_horario" style="display:none;">Agregar uno personalizado <i class='bx bx-plus'></i></button>
    <div class="row mt-2">
        <div class="col-12 alerta" style="display: none">
        ...
        <div class="col-xl-8 col-lg-8 col-12" id="tabla_horas" style="display: none">
            <div class="table-responsive">
                <table class="table table-bordered table-striped nowrap" id="tabla_horas_medico" style="width: 100%">
                    <thead>
                        <tr>
                            <th>#</th>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
               <h5 id="text_modal_new_horario float-end"> Nuevo horario</h5>
               <button class="btn btn-rounded btn-danger float-start" id="exit_"><i class='bx bxs-exit'></i> Salir</button>
            ...
            <div class="modal-footer">
                <div class="d-flex flex-row">
                    <button class="btn btn-success btn-rounded m-1" id="save_hour">Guardar <i class='bx bxs-save'></i></button>
