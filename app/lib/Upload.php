...
use Request;
// propiedades
private static string $DestinoFoto = "public/asset/foto/"; /// ruta donde se almacena las fotos de los usuarios

private static string|null $NameFoto = null; // recuperamos el nombre de la foto

private static array $TypeImagenAccep = ['image/jpeg','image/png'];
